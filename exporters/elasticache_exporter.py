...
reserved_cache_node_types_gauge = Gauge('aws_elasticache_reserved_node_types', 'Number of reserved ElastiCache nodes by type', ['account_id', 'region', 'instance_type'])
...
def collect_elasticache_metrics(region='us-east-1'):
    ...
    # Count reserved instances by node type
